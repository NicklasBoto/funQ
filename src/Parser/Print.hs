...
instance Print Parser.Abs.Term where
  prt i e = case e of
    ...
    Parser.Abs.TLamb lambda funvar type_ term -> prPrec i 1 (concatD [doc (showString "λ"), prt 0 funvar, doc (showString ":"), prt 0 type_, doc (showString "."), prt 0 term])
...
instance Print Parser.Abs.Type where
  prt i e = case e of
    ...
    Parser.Abs.TypeVoid -> prPrec i 2 (concatD [doc (showString "⊤")])
...
instance Print Parser.Abs.Gate where
  prt i e = case e of
    ...
    Parser.Abs.GCR8D -> prPrec i 0 (concatD [doc (showString "CR8aaaaaaaaaaaaaaaaaaaaaaaaaaaD")])
