...
instance Print Parser.Abs.Term where
  prt i = \case
    ...
    Parser.Abs.TLamb lambda funvar type_ term -> prPrec i 1 (concatD [prt 0 lambda, prt 0 funvar, prt 0 type_, doc (showString "."), prt 0 term])
...
instance Print Parser.Abs.Gate where
  prt i = \case
    ...
    Parser.Abs.GQFTI -> prPrec i 0 (concatD [doc (showString "QFTI")])
    Parser.Abs.GQFT2 -> prPrec i 0 (concatD [doc (showString "QFT2")])
    Parser.Abs.GQFTI2 -> prPrec i 0 (concatD [doc (showString "QFTI2")])
    Parser.Abs.GQFT3 -> prPrec i 0 (concatD [doc (showString "QFT3")])
    Parser.Abs.GQFTI3 -> prPrec i 0 (concatD [doc (showString "QFTI3")])
    Parser.Abs.GQFT4 -> prPrec i 0 (concatD [doc (showString "QFT4")])
    Parser.Abs.GQFTI4 -> prPrec i 0 (concatD [doc (showString "QFTI4")])
    Parser.Abs.GQFT5 -> prPrec i 0 (concatD [doc (showString "QFT5")])
    Parser.Abs.GQFTI5 -> prPrec i 0 (concatD [doc (showString "QFTI5")])
    ...
    Parser.Abs.GCR8D -> prPrec i 0 (concatD [doc (showString "CR8D")])
    Parser.Abs.GCCR -> prPrec i 0 (concatD [doc (showString "CCR")])
    Parser.Abs.GCCR2 -> prPrec i 0 (concatD [doc (showString "CCR2")])
    Parser.Abs.GCCR4 -> prPrec i 0 (concatD [doc (showString "CCR4")])
    Parser.Abs.GCCR8 -> prPrec i 0 (concatD [doc (showString "CCR8")])
