...
instance Print Parser.Abs.Function where
  prt i e = case e of
    Parser.Abs.FDef variable args term -> prPrec i 0 (concatD [prt 0 variable, prt 0 args, doc (showString "="), prt 0 term])

instance Print Parser.Abs.Arg where
  prt i e = case e of
    Parser.Abs.FArg variable -> prPrec i 0 (concatD [prt 0 variable])
  prtList _ [] = concatD []
